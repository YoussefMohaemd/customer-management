...
export const CUSTOMER_COLUMNS: readonly CustomerColumnDef[] = [
  ...
  { field: 'nameEn', label: 'English Name', type: 'text' },
  { field: 'nameAr', label: 'Arabic Name', type: 'rtl' },
  {
    field: 'email',
    label: 'Email',
    type: 'email',
  ...
  { field: 'phone', label: 'Phone', type: 'ltr', align: 'center' },
  { field: 'phone2', label: 'Phone 2', type: 'ltr', align: 'center' },
  { field: 'fax', label: 'Fax', type: 'ltr', align: 'center' },
  { field: 'website', label: 'Website', type: 'link' },
  { field: 'jobTitle', label: 'Job Title', type: 'text' },
  { field: 'clientType', label: 'Client Type (raw)', type: 'text', align: 'center' },
  {
  ...
  { field: 'classificationName', label: 'Classification', type: 'text', align: 'center' },
  { field: 'businessFieldName', label: 'Business Field', type: 'text', align: 'center' },
  { field: 'regionName', label: 'Region', type: 'text', align: 'center' },
  { field: 'gender', label: 'Gender', type: 'text', align: 'center' },
  { field: 'status', label: 'Status', type: 'tag', align: 'center' },
  { field: 'birthDate', label: 'Birth Date', type: 'date', align: 'center' },
  { field: 'registrationDate', label: 'Registration Date', type: 'date', align: 'center' },
  { field: 'createdDate', label: 'Created Date', type: 'date', align: 'center' },
  { field: 'address', label: 'Address', type: 'text' },
  { field: 'comment', label: 'Comment', type: 'text' },
  { field: 'taxFileNumber', label: 'Tax File Number', type: 'text', align: 'center' },
  {
  ...
  { field: 'vatRegistrationNumber', label: 'VAT Reg. No.', type: 'text', align: 'center' },
];
