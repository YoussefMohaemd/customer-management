...
const ACTION_CARDS: readonly CustomerActionDef[] = [
  {
    ...
    description: 'use a template to reassign customers in bulk',
    accent: 'blue',
  ...
  },
  {
    ...
    description: 'Use a template to follow up customers ',
    accent: 'amber',
  ...
  },
  {
    ...
    title: 'Upload Bulk',
    description: 'use a template to upload bulk customers data ',
    accent: 'emerald',
  },
];
