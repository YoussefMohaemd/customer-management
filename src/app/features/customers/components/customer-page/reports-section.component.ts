    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
      @for (report of cards; track report.title) {
        ...
        >
          ...
          <div class="p-4">
            <div
              class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-slate-50 text-slate-500 transition group-hover:bg-blue-50 group-hover:text-blue-600"
              aria-hidden="true"
            >
